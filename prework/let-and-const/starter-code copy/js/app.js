...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT  the previous line was error because when I changed var to let became the rando not global can't using it out of function but when I use var can use the rando out of function by consol.log()
  console.log(viewed);
